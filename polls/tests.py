...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        index page.
        """
        question = create_question(question_text="Past question.", pub_days=-5, end_days=-3)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_future_question(self):
        ...
        the index page.
        """
        create_question(question_text="Future question.", pub_days=3, end_days=5)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = create_question(question_text="Past question 1.", pub_days=-5, end_days=-3)
        question2 = create_question(question_text="Past question 2.", pub_days=-4, end_days=-3)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question2, question1],
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        """
        future_question = create_question(question_text='Future question.', pub_days=3, end_days=5)
    ...
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text='Past Question.', pub_days=-5, end_days=5)
